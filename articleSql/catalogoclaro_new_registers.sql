...
DROP TABLE IF EXISTS `new_registers`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `new_registers` (
  `id_register` int(11) NOT NULL,
  `id_prev_register` int(11) NOT NULL,
...
LOCK TABLES `new_registers` WRITE;
/*!40000 ALTER TABLE `new_registers` DISABLE KEYS */;
/*!40000 ALTER TABLE `new_registers` ENABLE KEYS */;
UNLOCK TABLES;
